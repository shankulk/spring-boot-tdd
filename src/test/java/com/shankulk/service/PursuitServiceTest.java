...
public class PursuitServiceTest {
  ...
  @Mock private PursuitDao pursuitDao;

  @InjectMocks private PursuitServiceImpl sut;
  ...
  void createPursuit_pursuitIdIsGenerated() {
    Pursuit pursuit =
        sut.createPursuit(
            "Pursuit 1", Objective.createObjective("obj1", "login", ObjectiveComparator.EQ, 2.0));
  ...
  void createPursuitWithObjective_save() {
    ...
    Pursuit pursuit =
        sut.createPursuit(
            "Pursuit 1",
            Objective.createObjective("obj1", "login", ObjectiveComparator.EQ, 1.9999999995));
